    ...
    <tr class="has-row-options">
        <td>
            ...
            <div class="row-options">
                ...
                | <a id="<?= 'note'.$meeting["id"] ?>" onclick="meetingNotes(this, <?= $meeting['id'] ?>)" title="Notes"
                    data-id="<?= $meeting["id"];  ?>" style="cursor:pointer;" role="button">Notes</a>
        ...
        <td>
            <div id="<?= 'noteBox'.$meeting["id"] ?>" class="hidden">
                        ...
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <textarea name="notes" class="ays-ignore"
                                    style="width:100%;">${data.note ? data.note : ''}</textarea>
                                <div class="from-group">
                                    <button class="btn btn-primary mtop10 pull-right"
                                        onclick="updateMeetingFormData()">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="edit_meeting_notes">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="from-group">
                            <button class="btn btn-primary mtop10 pull-right"
                                onclick="updateMeetingFormData()">${lang_save}</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
function meetingNotes(elmnt, id) {

    $("#noteBox" + id).toggleClass("hidden");
