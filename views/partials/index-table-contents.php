        ...
        <tr class="has-row-options">
            <td>
                ...
                <div class="row-options">
                    ...
                    | <a data-toggle="collapse" title="Notes" data-id="<?= $meeting["id"];  ?>" onclick="editMeetingNotes(this)" style="cursor:pointer;" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Notes</a>
