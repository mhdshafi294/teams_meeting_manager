...
update_option('tmm_app_redirect_uri', admin_url('teams_meeting_manager/meetings/callback'));
...
<div class="form-group">
    ...
    <input type="text" class="form-control" value="<?= $_teamsAppSecret; ?>" id="tmm_app_secret"
        name="settings[tmm_app_secret]">
</div>
<div class="form-group">
